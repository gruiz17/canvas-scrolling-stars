...
e,b,this.speed,this.direction,this.color,this.parentArray));e=this.parentArray.indexOf(this);return this.parentArray.splice(e,1)};return a}();h=jQuery;window.canvas=document.getElementById("game");window.rect=window.canvas.getBoundingClientRect();window.canvas.width=window.canvas.height=570;window.ctx=window.canvas.getContext("2d");window.starField=new m("CIRCLE",1,1.5,"UP","#ffffff",100);h("#game").click(function(a){});h("#game").attr("tabindex","0").keydown(function(a){console.log(a.keyCode);87===
a.keyCode&&window.starField.setDirection("UP");83===a.keyCode&&window.starField.setDirection("DOWN");65===a.keyCode&&window.starField.setDirection("LEFT");68===a.keyCode&&window.starField.setDirection("RIGHT");81===a.keyCode&&window.starField.freeze();69===a.keyCode&&window.starField.resume();74===a.keyCode&&window.starField.changeSpeed(-1);if(75===a.keyCode)return window.starField.changeSpeed(1)});h("#gamebox").mousemove(function(a){});p=function(){window.starField.moveStars()};n=function(){window.ctx.clearRect(0,
